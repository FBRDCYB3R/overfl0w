<?php
    ...
    if (ISSET($_POST['name'], $_POST['title'], $_POST['country'], $_POST['post'])) {
        $post = "<div id='new' style='border-radius: 5px; background-color: #292b2e; margin: auto; padding: 20px; position: relative; height: auto; width: 69vw;'>".'<txt style=\'font: 2vw Papyrus; color: silver;\'>'.$_POST['name'].' ('.$_POST['country'].')<br><br></txt>'."<div id='newtd' style='border-radius: 5px; background-image: linear-gradient(to bottom right, #182841, #450045); height: 3vw; width: auto; text-align: center;'><h3 id='newtt' style='color: silver; font: 2vw Papyrus; line-height: 0'>".$_POST['title']."</h3></div><br><br><div id='newpd' style='border-radius: 5px; background-image: linear-gradient(to bottom right, #182841, #450045); height: auto; width: auto; text-align: center;'><br><br><p id='newpp' style='color: silver; font: 1.25vw Papyrus;'>".$_POST['post']."</p><br><br></div></div>";
